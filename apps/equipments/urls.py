...
from apps.equipments.views import equipments, new_equipment, edit_equipment, delete_equipment, issued_equipment, issue_equipment, delete_issued_equipment, mark_issued_equipment
